            ...
            <div className="container justify-content-center">
              <div className="d-flex flex-wrap align-items-center justify-content-center">
                <ul className="nav my-2 justify-content-center my-md-0">
                  ...
                  <li className="nav-item"><a href="#charity-section" className="nav-link">
                  ...
                  <li className="nav-item"><a href="#where-and-when-section" className="nav-link">
                    ...
                    Коли та Де?</a></li>
                  <li className="nav-item"><a href="#checklist-section" className="nav-link">
                  ...
                  <li className="nav-item"><a href="#media-section" className="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-camera d-block mx-auto mb-1" viewBox="0 0 16 16">
