          ...
          <div className={clsx([style.defaultHeader, isSticky && style.sticky, !toShow && style.hidden, 'navbar navbar-expand bg-body-tertiary'])}>
            <div className="container justify-content-center">
              <div className="d-flex flex-wrap align-items-center justify-content-center">
                <ul className="nav my-2 justify-content-center my-md-0 text-small">
                  <li className="nav-item"><a href="#" className="nav-link active" aria-current="page">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi d-block mx-auto mb-1" viewBox="0 0 23 23">
                  ...
                  <li className="nav-item"><a href="#" className="nav-link">
                    ...
                    Коли та Де?</a></li>
                  <li className="nav-item"><a href="#" className="nav-link text-secondary">
                  ...
                  <li className="nav-item"><a href="#" className="nav-link">Відгук</a></li>
                </ul>
              </div>
            </div>
      </div>}
